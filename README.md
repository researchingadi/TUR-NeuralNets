...
**Target Venues:** Physical Review E · Journal of Statistical Mechanics · ICLR/ICML Workshop  
...
>
> $$\frac{\operatorname{Var}(J)}{\langle J \rangle^2} \geq \frac{2}{\dot{S}_{\mathrm{train}}}$$
>
...
$$\boxed{\frac{\operatorname{Var}(J)}{\langle J \rangle^2} \geq \frac{2}{\dot{S}}}$$
...
$$\text{TUR-ratio}_t = \frac{\operatorname{Var}(J)_W}{\langle J \rangle_W^2} \cdot \hat{\dot{S}}_t$$
